...
# --------------------------------------------------
# 2. Convert images to ALIKED input format
# --------------------------------------------------
...
for i, descriptor in enumerate(descriptors1):
    ...
    # L2 distance to every descriptor in frame 2
    ...
    # Find nearest and second-nearest descriptors
